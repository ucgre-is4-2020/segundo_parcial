...
<body>
	<h1>Registrar Nueva Rol</h1>
	<form action="creacionRol" method="POST">
		@csrf
		<table>
			<tr>
				<td>
			...
			<tr>
				...
				<td>
					<input type="text" name="codigo" id="codigo" value="{{ old('codigo') }}" pattern="[A-Za-z0-9]{1,40}" required="required"
					value="{{ old('codigo') }}">
				</td>
			</tr>
