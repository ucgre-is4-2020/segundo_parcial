...
<a href="{{ route ('tp2-ug0317-crear-ciudad') }}">Nuevo Resgistro</a>
...
<ul>
	@foreach($misListados->sortBy('id') as $unListado)
		...
		<li> 
			...
			<a href="{{route('tp2-ug0317-ver-ciudad', ['id' => $unListado->id]) }}"> Ver - </a>
			<a href="{{route('tp2-ug0317-borrar-ciudad', ['id' => $unListado->id])}}" onclick= "return confirm('Estas Seguro de Eliminar este Registro?')"> Borrar -</a>
			<a href="{{route('tp2-ug0317-editar-ciudad', ['id' => $unListado->id]) }}"> Editar </a>
