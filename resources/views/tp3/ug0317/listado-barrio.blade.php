...
<a href="{{ route ('tp3-ug0317-crear-barrio') }}">Nuevo Resgistro</a>
...
<ul>
	@foreach($misListados->sortBy('id') as $unListado)
		...
		<li>
			...
			<a href="{{route('tp3-ug0317-ver-barrio', ['id' => $unListado->id]) }}"> Ver - </a>
			<a href="{{route('tp3-ug0317-borrar-barrio', ['id' => $unListado->id])}}" onclick= "return confirm('Estas Seguro de Eliminar este Registro?')"> Borrar -</a>
			<a href="{{route('tp3-ug0317-editar-barrio', ['id' => $unListado->id]) }}"> Editar </a>
